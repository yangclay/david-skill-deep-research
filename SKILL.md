...
2. 洞察透镜扫语境找张力点——透镜清单（考古场景最常用的 5 条）：**主要矛盾**（多个矛盾中哪个是主要的，解决它其他是否缓解）｜**呈现问题 vs 真正议题**（用户问的是表面还是真正要解决的）｜**隐性约束**（没说出口的时间/资源/已投入成本）｜**二阶思维**（方案的一阶后果之外，二阶呢）｜**替代解释**（认定的原因是唯一解释吗）→ 每个张力点转成一个可检索子问题，共 3±2 个
